...
<div class="gde-page-outer-wrapper">
    ...
    <div class="gde-breadcrumbs-wrapper">
        <p><a href="<?php echo home_url(); ?>">Hem</a> / <a href="../../nyheter">Nyheter</a> / Kategori </p>
    </div>
    ...
    <div class="gde-page-wrapper">
            ...
            <a href="javascript:history.back();">
                <div class="gde-back-to-page-first"><img src="<?php bloginfo('template_directory'); ?>/assets/icons/long-arrow-left-light.svg" class="back-icon" /><p>Tillbaka</p></div>
            </a>
